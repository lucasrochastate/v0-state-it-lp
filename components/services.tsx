import { Code2, Lock, Search, FileCode, GitBranch, ServerCog } from "lucide-react"
...
const services = [
  {
    ...
    description:
      "Arquitetura, code review e desenvolvimento. Ajudamos seu time a escalar sem perder qualidade.",
  },
  {
    icon: Lock,
    title: "AppSec",
  ...
  {
    icon: Search,
    title: "Pentest & Code Review",
    description:
      "Testes de intrus\u00e3o e revis\u00e3o manual de c\u00f3digo. O tipo de coisa que previne dor de cabe\u00e7a l\u00e1 na frente.",
  },
  {
    icon: FileCode,
    title: "Secure SDLC",
    description:
      "Seguran\u00e7a integrada no dia a dia do desenvolvimento, n\u00e3o s\u00f3 no final do sprint.",
  },
  {
    icon: GitBranch,
    title: "DevSecOps",
...
export function Services() {
  return (
    <section id="servicos" className="border-t border-border/50 px-6 py-24 lg:py-32">
